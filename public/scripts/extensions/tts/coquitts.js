...
class CoquiTtsProvider {
    ...
    loadSettings(settings) {
        ...
        textexample.placeholder =
            "Enter comma separated map of charName:ttsName[speakerID][langID]. Example: \nAqua:tts_models--en--ljspeech--glow-ttsmodel_file.pth,\nDarkness:tts_models--multilingual--multi-dataset--your_ttsmodel_file.pth[2][3]";
    ...
    async getVoice(voiceName) {
        ...
        if (this.voices.length === 0) {
            this.voices = await this.fetchCheckMap();
        }
