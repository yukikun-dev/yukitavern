...
class ArrayKeyedMap {
    ...
    hasPrefix(path) {
        return hasPrefix.call(this, path);
    }
    ...
    *keys() {
        yield* keys.call(this);
    }

    *values() {
        yield* values.call(this);
    }

    forEach(callback, thisArg) {
        forEach.call(this, callback, thisArg);
    }
}
