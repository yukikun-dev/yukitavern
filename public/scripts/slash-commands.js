...
parser.addCommand(
    ...
    setNameCallback,
    ["persona"],
    '<span class="monospace">(name)</span> – sets user name and persona avatar (if set)',
    true,
    true,
);
parser.addCommand(
    ...
    syncCallback,
    [],
    " – syncs user name in user-attributed messages in the current chat",
    true,
    true,
);
parser.addCommand(
    ...
    bindCallback,
    ["bind"],
    " – locks/unlocks a persona (name and avatar) to the current chat",
    true,
    true,
);
parser.addCommand(
    ...
    ["background"],
    '<span class="monospace">(filename)</span> – sets a background according to filename, partial names allowed, will set the first one alphabetically if multiple files begin with the provided argument string',
    false,
    true,
);
parser.addCommand(
    ...
    sendMessageAs,
    [],
    ' – sends message as a specific character.<br>Example:<br><pre><code>/sendas Chloe\nHello, guys!</code></pre>will send "Hello, guys!" from "Chloe".<br>Uses character avatar if it exists in the characters list.',
    true,
    true,
);
parser.addCommand(
    ...
    sendNarratorMessage,
    [],
    '<span class="monospace">(text)</span> – sends message as a system narrator',
    false,
    true,
);
parser.addCommand(
    ...
    setNarratorName,
    [],
    '<span class="monospace">(name)</span> – sets a name for future system narrator messages in this chat (display only). Default: System. Leave empty to reset.',
    true,
    true,
);
parser.addCommand(
    ...
    sendCommentMessage,
    [],
    '<span class="monospace">(text)</span> – adds a note/comment message not part of the chat',
    false,
    true,
);
parser.addCommand(
    "single",
    setStoryModeCallback,
    ["story"],
...
parser.addCommand(
    "bubble",
    setBubbleModeCallback,
    ["bubbles"],
    " – sets the message style to bubble chat mode",
    true,
    true,
);
parser.addCommand(
...
parser.addCommand(
    ...
    ["char"],
    '<span class="monospace">(name)</span> – opens up a chat with the character by its name',
    true,
    true,
);
parser.addCommand(
    ...
    [],
    '<span class="monospace">(prompt)</span> – generates a system message using a specified prompt',
    true,
    true,
);
parser.addCommand(
    "delname",
    deleteMessagesByNameCallback,
    ["cancel"],
    '<span class="monospace">(name)</span> – deletes all messages attributed to a specified name',
    true,
    true,
);
parser.addCommand(
    ...
    ["add"],
    '<span class="monospace">(text)</span> – adds a user message to the chat log without triggering a generation',
    true,
    true,
);
